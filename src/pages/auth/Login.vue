                ...
                <div class="w-full max-w-md">
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col items-center gap-1 text-center">
                            ...
                            <p class="text-md text-gray-600">Enter your username below to login to your account</p>
                        </div>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input 
                                ...
                                :disabled="loading"
                                :class="{
                                    'border-red-500': (errors.username || validateField('username')),
                                    'border-gray-300': !(errors.username || validateField('username'))
                                }"
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input 
                                ...
                                :disabled="loading"
                                :class="{
                                    'border-red-500': (errors.password || validateField('password')),
                                    'border-gray-300': !(errors.password || validateField('password'))
                                }"
                        ...
                        <div class="relative">
                            ...
                            <div class="relative flex justify-center text-xs">
                                <span class="bg-white text-sm px-2 text-gray-500">Or continue with</span>
                            </div>
                        </div>
