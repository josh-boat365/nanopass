...
const categories = ref([
    { id: 1, name: 'General', description: 'General system settings and configurations.' },
    { id: 2, name: 'Security', description: 'Security-related settings and policies.' },
    { id: 3, name: 'Performance', description: 'Performance optimization settings.' },
])
    ...
    <BaseLayout>
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">System Categories</h1>
                    <p class="text-gray-600 text-sm mt-1">Manage system categories for organization and classification.
                    </p>
                </div>
            ...
            <div class="mb-6 flex items-center gap-4">
                <div class="flex-1">
                    <input v-model="searchQuery" @input="updateFilteredCategories" type="text"
            ...
            <div class="rounded-lg border bg-white shadow-sm overflow-hidden">
                ...
                <!-- Empty state -->
                <div v-if="filteredCategories.length === 0" class="px-6 py-12 text-center">
                    <p class="text-gray-500 text-sm">
                        {{ searchQuery.trim() ? 'No categories match your search.' : 'Nocategories found. Create your first one.' }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <div v-if="showAddModal"
            ...
            <div class="relative w-full max-w-md rounded-lg bg-white shadow-xl">
                ...
                <div class="px-6 py-4 space-y-4">
                    <div>
                        <label for="add-name" class="block text-sm font-medium text-gray-900 mb-1">Category Name</label>
                        <input id="add-name" v-model="formData.name" type="text" placeholder="Enter category name"
        ...
        <div v-if="showEditModal"
            ...
            <div class="relative w-full max-w-md rounded-lg bg-white shadow-xl">
                ...
                <div class="px-6 py-4 space-y-4">
                    <div>
                        <label for="edit-name" class="block text-sm font-medium text-gray-900 mb-1">Category
                            Name</label>
                        <input id="edit-name" v-model="formData.name" type="text" placeholder="Enter category name"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" />
                    </div>
                    <div>
                ...
                <div class="px-6 py-4">
                    <p class="text-sm text-gray-600">
                        Are you sure you want to delete <span class="font-semibold text-gray-900">{{
                            selectedCategory?.name }}</span>? This action cannot be undone.
                    </p>
                </div>
